...
export interface IOrderMassStatusRequest {
  ...
  UnderlyingInstrument?: IUnderlyingInstrument// [10] UnderlyingSymbol.311, UnderlyingSymbolSfx.312 .. UnderlyingDetachmentPoint.1460
  Side?: string// [11] 54 (String)
  StandardTrailer: IStandardTrailer// [12] SignatureLength.93, Signature.89, CheckSum.10
  TargetParties?: ITargetParties[]// [13] TargetPartyID.1462, TargetPartyIDSource.1463, TargetPartyRole.1464
}
