...
export interface INestedParties3NoNested3PartyIDs {
  ...
  Nested3PartyRoleQualifier?: number// [4] 2382 (Int)
  NstdPtys3SubGrp?: INstdPtys3SubGrp// [5] NoNested3PartySubIDs.952, Nested3PartySubID.953, Nested3PartySubIDType.954
}
