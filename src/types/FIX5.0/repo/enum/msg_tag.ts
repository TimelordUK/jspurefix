...
/*
****************************************************************
* Can be used for SecurityType (167) =OPT to identify a        *
* particular security.                                         *
...
* following capital adjustments (0=current, 1=prior, 2=prior   *
* to , etc).                                                   *
****************************************************************
*/
  OptAttribute = 206,
...
/*
************************************************************
* Underlying security's PutOrCall. See PutOrCall field for *
* description                                              *
************************************************************
*/
...
/*
****************************************************************
* Total amount traded (e.g. CumQty (14) * AvgPx (6)) expressed *
* in units of currency. For FX Futures this is used to express *
* the notional value of a fill when LastQty and other quantity *
* fields are express in terms of contract size.                *
****************************************************************
*/
  GrossTradeAmt = 381,
/*
...
* (e.g. for SecurityType="REPO"), or the CFICode if            *
* SecurityType is not specified. If specified, SecuirtyType or *
* CFICode is required.                                         *
* Example Values:                                              *
...
/*
**********************************************************
* Security Report ID. Unique identifier for the Security *
* Report.                                                *
**********************************************************
*/
...
/*
*********************************************************
* Specific to the &lt;UnderlyingInstrument&gt; Used for *
* derivatives that deliver into cash underlying.        *
*********************************************************
*/
...
* NOTE: Additional values may be used by mutual agreement of *
* the counterparties                                         *
* (http://www.unc.edu/~rowlett/units/index.html is a good    *
* source for units)                                          *
**************************************************************
*/
  UnitofMeasure = 996,
...
* execution venue (Y) or not (N). A default of N  customer   *
* didnt direct this order  should beused in the case where  *
* the information is both missing and essential.              *
***************************************************************
*/
...
* For DeskTypeSource (1034) = 1 (NASD OATS), valid values are *
* (as of OATS Phase 3 as provided by NASD. See also           *
* http://www.nasd.com/oats/PhaseIII for a complete list.      *
***************************************************************
*/
...
/*
****************************************************************
* Foreign exchange rate used to compute UnderlyingCurrentValue *
* (885) (or market value) from UnderlyingCurrency (318) to     *
* Currency (15).                                               *
****************************************************************
*/
...
/*
************************************************************
* Shows that the reported price that is different from the *
* market price                                             *
************************************************************
*/
  ReportedPxDiff = 1134,
