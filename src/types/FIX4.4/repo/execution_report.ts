...
export interface IExecutionReport {
  ...
  Parties?: IParties[]// [14] PartyID.448, PartyIDSource.447 .. PartySubIDType.803
  TradeOriginationDate?: Date// [15] 229 (LocalDate)
  ContraGrp?: IContraGrp[]// [16] ContraBroker.375, ContraTrader.337 .. ContraLegRefID.655
  ...
  UndInstrmtGrp?: IUndInstrmtGrp[]// [40] UnderlyingSymbol.311, UnderlyingSymbolSfx.312 .. UnderlyingStipValue.889
  Side: string// [41] 54 (String)
  Stipulations?: IStipulations[]// [42] StipulationType.233, StipulationValue.234
  ...
  EncodedTextLen?: number// [119] 354 (Int)
  ...
  ContAmtGrp?: IContAmtGrp[]// [136] ContAmtType.519, ContAmtValue.520, ContAmtCurr.521
  InstrmtLegExecGrp?: IInstrmtLegExecGrp[]// [137] LegSymbol.600, LegSymbolSfx.601 .. LegLastPx.637
  CopyMsgIndicator?: boolean// [138] 797 (Boolean)
  MiscFeesGrp?: IMiscFeesGrp[]// [139] MiscFeeAmt.137, MiscFeeCurr.138 .. MiscFeeBasis.891
