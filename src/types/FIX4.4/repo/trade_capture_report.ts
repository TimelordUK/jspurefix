...
export interface ITradeCaptureReport {
  ...
  UndInstrmtGrp?: IUndInstrmtGrp[]// [31] UnderlyingSymbol.311, UnderlyingSymbolSfx.312 .. UnderlyingStipValue.889
  ...
  PositionAmountData?: IPositionAmountData[]// [45] PosAmtType.707, PosAmt.708
  MultiLegReportingType?: string// [46] 442 (String)
  TradeLegRefID?: string// [47] 824 (String)
  TrdInstrmtLegGrp?: ITrdInstrmtLegGrp[]// [48] LegSymbol.600, LegSymbolSfx.601 .. LegLastPx.637
  TransactTime: Date// [49] 60 (UtcTimestamp)
  TrdRegTimestamps?: ITrdRegTimestamps[]// [50] TrdRegTimestamp.769, TrdRegTimestampType.770, TrdRegTimestampOrigin.771
  ...
  TrdCapRptSideGrp: ITrdCapRptSideGrp[]// [55] Side.54, OrderID.37 .. AllocQty.80
