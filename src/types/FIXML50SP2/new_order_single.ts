...
export interface INewOrderSingle {
  ...
  OrderQtyData?: IOrderQtyData// [14] Qty.38, Cash.152 .. RndMod.469
  TriggeringInstruction?: ITriggeringInstruction// [15] TrgrTyp.1100, TrgrActn.1101 .. TrgrTrdSessSubID.1114
  SpreadOrBenchmarkCurveData?: ISpreadOrBenchmarkCurveData// [16] Spread.218, Ccy.220 .. SecIDSrc.761
  YieldData?: IYieldData// [17] Typ.235, Yld.236 .. RedPxTyp.698
  CommissionData?: ICommissionData// [18] Comm.12, CommTyp.13 .. FundRenewWaiv.497
  CommissionDataGrp?: ICommissionDataGrp[]// [19] Amt.2640, Typ.2641 .. EncDesc.2652
  OrderAttributeGrp?: IOrderAttributeGrp[]// [20] Typ.139, Val.2595
  PegInstructions?: IPegInstructions// [21] OfstVal.211, PegPxTyp.1094 .. PegSecDesc.1099
  DiscretionInstructions?: IDiscretionInstructions// [22] DsctnInst.388, OfstValu.389 .. Scope.846
  StrategyParametersGrp?: IStrategyParametersGrp[]// [23] StrtPrmNme.958, StrtPrmTyp.959, StrtPrmVal.960
  TrdRegTimestamps?: ITrdRegTimestamps[]// [24] TS.769, Typ.770 .. InfoBrrID.1727
}
