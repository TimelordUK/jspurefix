...
export interface IQuoteAcknowledgementNoQuoteSets {
  ...
  TotQuoteEntries?: number// [21] 304 (Int)
  NoQuoteEntries?: IQuoteAcknowledgementNoQuoteSetsNoQuoteEntries[]// [22] QuoteEntryID.299, Symbol.55 .. QuoteEntryRejectReason.368
}
