...
let clientFactory: Fix44MsgFactory
let serverFactory: Fix44MsgFactory
...
beforeEach(async () => {
  ...
  clientFactory = new Fix44MsgFactory(clientDescription)
  serverFactory = new Fix44MsgFactory(serverDescription)
